...
const ServiceCardNew = ({
  ...
  return (
    <div className="flex flex-col bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-white/10 hover:border-[#B8956A]/50 hover:-translate-y-1">
      <div
